...
def github_login(request):
    ...
    redirect_uri = "http://airbnb.eba-q2n3vcxx.ap-northeast-2.elasticbeanstalk.com/users/login/github/callback"
    return redirect(
...
def kakao_login(request):
    ...
    redirect_uri = "http://airbnb.eba-q2n3vcxx.ap-northeast-2.elasticbeanstalk.com/users/login/kakao/callback"
    return redirect(
...
class UpdateProfileView(mixins.LoggedInOnlyView, SuccessMessageMixin, UpdateView):
    ...
    def get_form(self, form_class=None):
        ...
        form.fields["birthdate"].widget.attrs = {
            "placeholder": "Birthdate, ex) 1900-01-01"
        }
        form.fields["first_name"].widget.attrs = {"placeholder": "First name"}
        form.fields["last_name"].widget.attrs = {"placeholder": "Last name"}
        form.fields["bio"].widget.attrs = {"placeholder": "Edit your bio"}
        return form
